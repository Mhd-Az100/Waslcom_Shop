...
class MtnLoginView extends StatelessWidget {
  SplashViewController ctrl = Get.find();
  @override
  Widget build(BuildContext context) {
    var controller = context.watch<MtnAuthViewController>();
